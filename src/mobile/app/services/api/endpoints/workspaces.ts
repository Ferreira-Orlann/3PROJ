...
const workspaceService = {
    ...
    getWorkspaceByUuid: async (uuid: UUID): Promise<Workspace> => {
        console.log(
            "getWorkspaceByUuid - Demande de workspace avec uuid:",
            uuid,
        );
        console.log(
            "getWorkspaceByUuid - URL de la requête:",
            `/workspaces/${uuid}`,
        );
        try {
            ...
            console.error(
                "getWorkspaceByUuid - Erreur lors de la récupération:",
                error,
            );
            throw error;
        }
    ...
    createWorkspace: async (
        ...
        console.log(
            "createWorkspace - Data sent to API:",
        ...
        console.log(
            "createWorkspace - Response from API:",
    ...
    joinWorkspace: async (
        uuid: UUID,
        memberData: AddMemberWorkspaceData,
    ): Promise<void> => {
