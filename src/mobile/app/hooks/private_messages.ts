...
import { Message, Attachment, Users, Conversations } from '../services/private_messages';
...
const SAMPLE_CONVERSATIONS: Conversations = {
  'dm1': [
    { id: 'm1', sender: 'Sophie Martin', content: 'Bonjour ! Comment avance le projet marketing ?', timestamp: '10:30', 
      reactions: [
    ...
    { id: 'm2', sender: 'Moi', content: 'Salut Sophie ! Ça avance bien, je viens de terminer la maquette.', timestamp: '10:32', reactions: [], attachments: [], avatar: null },
    { id: 'm3', sender: 'Sophie Martin', content: 'Super ! Tu peux me l\'envoyer pour que je puisse y jeter un œil ?', timestamp: '10:35', reactions: [], attachments: [], avatar: null },
  ],
  'dm2': [
    { id: 'm1', sender: 'Thomas Bernard', content: 'As-tu reçu mon email concernant la réunion de demain ?', timestamp: '09:15', reactions: [], attachments: [], avatar: null },
    { id: 'm2', sender: 'Moi', content: 'Oui, je l\'ai bien reçu. Je serai présent.', timestamp: '09:20', reactions: [], attachments: [], avatar: null },
  ],
  'dm3': [
    { id: 'm1', sender: 'Julie Dubois', content: 'Bonjour, pourrais-tu m\'aider avec le rapport trimestriel ?', timestamp: '14:05', reactions: [], attachments: [], avatar: null },
  ],
  'dm4': [
    { id: 'm1', sender: 'Moi', content: 'Salut Marc, as-tu des nouvelles du client ?', timestamp: '11:45', reactions: [], attachments: [], avatar: null },
  ],
};
        ...
        if (existingReactionIndex >= 0) {
          ...
          if (reaction.count > 1) {
            ...
            updatedReactions[existingReactionIndex] = {
              ...
              users: reaction.users.filter(u => u !== 'currentUser')
            };
