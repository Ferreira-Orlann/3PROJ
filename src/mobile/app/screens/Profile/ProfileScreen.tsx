...
import { View, Text, TextInput, TouchableOpacity, ScrollView, Switch, Modal, ActivityIndicator } from 'react-native';
    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView style={styles.content}>
        {isLoading ? (
          <View style={{
            ...
            <Text style={{
              ...
              fontSize: 16,
              textAlign: 'center'
            }}>Chargement de votre profil...</Text>
          </View>
        ) : (
          <>
            <View style={styles.avatarSection}>
              <View style={styles.avatarContainer}>
                <Text style={styles.avatarText}>{userProfile.firstName.charAt(0)}{userProfile.lastName.charAt(0)}</Text>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.inputContainer}>
            <FontAwesome name="id-card-o" size={20} color="#666" style={styles.icon} />
            <TextInput
              style={styles.input}
        ...
        <View style={styles.section}>
          ...
          <View style={styles.preferenceItem}>
            ...
            <Switch
              ...
              thumbColor={preferences.isDarkTheme ? '#f5dd4b' : '#f4f3f4'}
              ios_backgroundColor="#3e3e3e"
              onValueChange={() => setPreferences(prev => ({ ...prev, isDarkTheme: !prev.isDarkTheme }))}
              value={preferences.isDarkTheme}
            />
          </View>
          
          <Text style={[styles.label, {marginTop: 15}]}>Statut personnalisé</Text>
          <View style={styles.statusContainer}>
            <TouchableOpacity 
              style={[styles.statusOption, userProfile.status === 'En ligne' && styles.statusActive]}
            ...
            <TouchableOpacity 
              style={[styles.statusOption, userProfile.status === 'Absent' && styles.statusActive]}
            ...
            <TouchableOpacity 
              style={[styles.statusOption, userProfile.status === 'Ne pas déranger' && styles.statusActive]}
              onPress={() => updateProfile('status', 'Ne pas déranger')}
            >
              <View style={[styles.statusDot, { backgroundColor: '#ff4444' }]} />
              <Text style={styles.statusText}>Ne pas déranger</Text>
            </TouchableOpacity>
            <TouchableOpacity 
              style={[styles.statusOption, userProfile.status === 'Hors ligne' && styles.statusActive]}
              onPress={() => updateProfile('status', 'Hors ligne')}
            >
        ...
        <View style={styles.section}>
          ...
          >
            <FontAwesome name="lock" size={20} color="#fff" style={styles.actionIcon} />
        ...
        <View style={styles.section}>
          <Text style={styles.sectionTitle}>Connexions externes (OAuth2)</Text>
          ...
          <View style={styles.oauthContainer}>
            <View style={styles.oauthItem}>
              ...
              <TouchableOpacity 
                style={[styles.oauthButton, connectedProviders.google ? styles.disconnectButton : styles.connectButton]}
                onPress={() => toggleOAuthConnection('google')}
              >
                <Text style={styles.oauthButtonText}>
                  {connectedProviders.google ? 'Déconnecter' : 'Connecter'}
                </Text>
              </TouchableOpacity>
            </View>
            ...
            <View style={styles.oauthItem}>
              <View style={styles.oauthInfo}>
                <FontAwesome name="github" size={20} color="#fff" style={styles.oauthIcon} />
                <Text style={styles.oauthText}>GitHub</Text>
              </View>
              <TouchableOpacity 
                style={[styles.oauthButton, connectedProviders.github ? styles.disconnectButton : styles.connectButton]}
                onPress={() => toggleOAuthConnection('github')}
              >
                <Text style={styles.oauthButtonText}>
                  {connectedProviders.github ? 'Déconnecter' : 'Connecter'}
                </Text>
              </TouchableOpacity>
            </View>
            ...
            <View style={styles.oauthItem}>
              <View style={styles.oauthInfo}>
                <FontAwesome name="windows" size={20} color="#00a1f1" style={styles.oauthIcon} />
                <Text style={styles.oauthText}>Microsoft</Text>
              </View>
              <TouchableOpacity 
                style={[styles.oauthButton, connectedProviders.microsoft ? styles.disconnectButton : styles.connectButton]}
                onPress={() => toggleOAuthConnection('microsoft')}
              >
                <Text style={styles.oauthButtonText}>
                  {connectedProviders.microsoft ? 'Déconnecter' : 'Connecter'}
                </Text>
              </TouchableOpacity>
            </View>
          </View>
        ...
        <View style={styles.section}>
          ...
          >
            ...
            <Text style={styles.actionText}>Exporter mes données personnelles</Text>
            {isExporting ? (
            ...
            <View style={styles.modalContent}>
              ...
              <View style={styles.modalInputContainer}>
                ...
                <TextInput
                  ...
                  onChangeText={(value) => updatePasswordInfo('currentPassword', value)}
              ...
              <View style={styles.modalInputContainer}>
                ...
                <TextInput
                  ...
                  onChangeText={(value) => updatePasswordInfo('newPassword', value)}
              ...
              <View style={styles.modalInputContainer}>
                ...
                <TextInput
                  ...
                  onChangeText={(value) => updatePasswordInfo('confirmPassword', value)}
