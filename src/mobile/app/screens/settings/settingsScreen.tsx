    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView style={styles.content}>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.option}>
            <View style={styles.optionInfo}>
              <FontAwesome name="envelope-o" size={20} color="#666" />
              <Text style={styles.optionText}>Notifications par email</Text>
            </View>
            <Switch
              value={emailNotifs}
        ...
        <View style={styles.section}>
          ...
          <TouchableOpacity style={styles.option} onPress={() => router.push('../profils')}>
            <View style={styles.optionInfo}>
