...
export default function DirectMessageScreen() {
  ...
  const { user, messages, handleSendMessage, handleAddReaction } = useDirectMessage(userId);
          ...
          <View style={styles.header}>
            ...
            <View style={styles.headerActions}>
              <TouchableOpacity style={styles.headerButton}>
                <Ionicons name="call" size={22} color="#8e9297" />
              </TouchableOpacity>
              <TouchableOpacity style={styles.headerButton}>
                <Ionicons name="videocam" size={22} color="#8e9297" />
              </TouchableOpacity>
              <TouchableOpacity style={styles.headerButton}>
                <Ionicons name="information-circle" size={22} color="#8e9297" />
              </TouchableOpacity>
            </View>
          </View>
